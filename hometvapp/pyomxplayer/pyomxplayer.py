...
class OMXPlayer(object):
    ...
    _LAUNCH_CMD = '/usr/bin/omxplayer -o hdmi -s %s %s'
    _PAUSE_CMD = 'p'
    _TOGGLE_SUB_CMD = 's'
    _QUIT_CMD = 'q'
    ...
    def __init__(self, mediafile, args=None, start_playback=False):
        ...
        self._process = pexpect.spawn(cmd, timeout=None)
        self.video = dict()
        self.audio = dict()
        # Get file properties
        file_props = [1,2,3,4]#self._FILEPROP_REXP.match(self._process.readline()).groups()
